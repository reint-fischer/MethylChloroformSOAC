...
def oneboxeulerfw(k,P,C0,dt,MW): # input in 1/year, Mtonnes/year, ppv, years and g/moles respectively
...
def oneboxRK4(k,P,C0,dt,MW):     # input in 1/year, Mtonnes/year, ppv, years and g/moles respectively
    Mair = 1.81*10**(20)         # mol of air in the entire atmosphere
    P = P*10**(12)               # Megatonnes to grams
    PM = P/MW                    # moles/year from grams/year
    Pv = PM/Mair                 # volume fraction/year
