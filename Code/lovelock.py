...
plt.savefig('Figures/LoveLock_logConcentration__Euler_and_RK4_comparison.png')
plt.show()
...
ax.plot(time, twoboxeulerfw(k,ke,P_constant,C0N,C0S,dt,MW)[0]*10**(12),label='NH')
ax.plot(time, twoboxeulerfw(k,ke,P_constant,C0N,C0S,dt,MW)[1]*10**(12),label='SH')
plt.yscale('log')
plt.ylim([1,100])
