...
plt.plot(time, oneboxRK4(k,P_constant,C0,dt,MW)*(10**12),label='RK4', color='C0')
ax = plt.gca()
ax.xaxis.set_major_locator(MaxNLocator(integer=True))
plt.yscale('log')
plt.ylim([10**-12,100*10**-12])
...
plt.plot(time, twoboxeulerfw(k,ke,P_constant,C0N,C0S,dt,MW)[1]*(10**12),label='SH')
ax = plt.gca()
ax.xaxis.set_major_locator(MaxNLocator(integer=True))
plt.yscale('log')
plt.ylim([1,100])
...
plt.savefig('Figures/Lovelock_logconcentration_twoboxmodel.png')
plt.show()
...
plt.plot(time, twoboxeulerfw(1/2*k,ke,P_constant,C0N,C0S,dt,MW)[1]*(10**12),'b',label='SH k = {0:.2f}'.format(1/2*k))
plt.plot(time, twoboxeulerfw(k,ke,P_constant,C0N,C0S,dt,MW)[0]*(10**12), color='black',label='NH k = {0:.2f}'.format(k))
plt.plot(time, twoboxeulerfw(k,ke,P_constant,C0N,C0S,dt,MW)[1]*(10**12), color='black',label='SH k = {0:.2f}'.format(k))
plt.plot(time, twoboxeulerfw(2*k,ke,P_constant,C0N,C0S,dt,MW)[0]*(10**12), 'r',label='NH k = {0:.2f}'.format(2*k))
plt.plot(time, twoboxeulerfw(2*k,ke,P_constant,C0N,C0S,dt,MW)[1]*(10**12), 'r',label='SH k = {0:.2f}'.format(2*k))
plt.plot(time, twoboxeulerfw(4*k,ke,P_constant,C0N,C0S,dt,MW)[0]*(10**12), 'c',label='NH k = {0:.2f}'.format(4*k))
plt.plot(time, twoboxeulerfw(4*k,ke,P_constant,C0N,C0S,dt,MW)[1]*(10**12), 'c',label='SH k = {0:.2f}'.format(4*k))
#plt.ticklabel_format(axis='y', scilimits=(-12,-12))
ax = plt.gca()
ax.xaxis.set_major_locator(MaxNLocator(integer=True))
plt.yscale('log')
...
plt.grid(axis='y',alpha=.3)
plt.legend(fontsize=12)
plt.savefig('Figures/Lovelock_logconcentration_twoboxmodel_varying_lifetime.png')
plt.show()
...
plt.grid(axis='y',alpha=.3)
plt.legend(fontsize=12)
plt.savefig('Figures/Lovelock_logconcentration_twoboxmodel_ceased_emissions.png')
plt.show()